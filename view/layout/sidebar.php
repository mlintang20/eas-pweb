<nav>
        ...
        <div class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[350px] overflow-y-auto text-center bg-blue-900">
            ...
            <a href="./pengumuman.php" class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                <i class="bi bi-card-heading"></i>
                <span class="text-[15px] ml-4 text-gray-200 font-bold">Pengumuman</span>
            </a>
